      ...
      <div class="row row-lg row-30 row-lg-30">
        <div class="col-sm-6 col-md-4 col-lg-3">
          ...
          <article class="product wow fadeInRight">
            <div class="product-body">
              <div class="product-figure"><img src="images/shop/shop-1.png" alt="" width="148" height="128" /> </div>
              <h5 class="product-title"><a href="single-product.html">Lorem Ipsum</a></h5>
            ...
            <div class="product-button-wrap">
              <div class="product-button"><a class="button button-gray-14 button-zakaria fl-bigmug-line-search74"
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          ...
          <article class="product wow fadeInRight" data-wow-delay=".1s">
            <div class="product-body">
              <div class="product-figure"><img src="images/shop/shop-2.png" alt="" width="128" height="220" /> </div>
              <h5 class="product-title"><a href="single-product.html">Lorem Ipsum</a></h5>
              <div class="product-price-wrap">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          ...
          <article class="product wow fadeInRight" data-wow-delay=".2s">
            <div class="product-body">
              <div class="product-figure"><img src="images/shop/shop-3.png" alt="" width="145" height="163" /> </div>
              <h5 class="product-title"><a href="single-product.html">Lorem Ipsum</a></h5>
              <div class="product-price-wrap">
                <div class="product-price">$17.00</div>
              </div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          ...
          <article class="product wow fadeInRight" data-wow-delay=".3s">
            <div class="product-body">
              <div class="product-figure"><img src="images/shop/shop-4.png" alt="" width="165" height="120" /> </div>
              <h5 class="product-title"><a href="single-product.html">Lorem Ipsum</a></h5>
              <div class="product-price-wrap">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          ...
          <article class="product wow fadeInLeft" data-wow-delay=".3s">
            <div class="product-body">
              <div class="product-figure"><img src="images/shop/shop-5.png" alt="" width="117" height="131" /> </div>
              <h5 class="product-title"><a href="single-product.html">Lorem Ipsum</a></h5>
              <div class="product-price-wrap">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          ...
          <article class="product wow fadeInLeft" data-wow-delay=".2s">
            <div class="product-body">
              <div class="product-figure"><img src="images/shop/shop-6.png" alt="" width="171" height="106" /> </div>
              <h5 class="product-title"><a href="single-product.html">Lorem Ipsum</a></h5>
              <div class="product-price-wrap">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          ...
          <article class="product wow fadeInLeft" data-wow-delay=".1s">
            <div class="product-body">
              <div class="product-figure"><img src="images/shop/shop-7.png" alt="" width="155" height="153" /> </div>
              <h5 class="product-title"><a href="single-product.html">Lorem Ipsum</a></h5>
              <div class="product-price-wrap">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          ...
          <article class="product wow fadeInLeft">
            <div class="product-body">
              <div class="product-figure"><img src="images/shop/shop-8.png" alt="" width="146" height="135" /> </div>
              <h5 class="product-title"><a href="single-product.html">Lorem Ipsum</a></h5>
              <div class="product-price-wrap">

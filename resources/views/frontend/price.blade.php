            ...
            <div class="row row-30 box-ochered">
                <div class="col-sm-6 col-lg-3">
                    <article class="box-icon-modern">
                        ...
                        <p class="box-icon-modern-text">Lorem Ipsum is simply dummy text of the printing and typesetting
                ...
                <div class="col-sm-6 col-lg-3">
                    <article class="box-icon-modern">
                        ...
                        <p class="box-icon-modern-text">Lorem Ipsum has been the industry's standach dummy text ever since
                            the 1500s, when an unknown printer took a galley book.</p>
                    </article>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <article class="box-icon-modern">

            ...
            <div class="row row-30">
                <div class="col-lg-6">
                    <div class="slick-vertical slick-product">
                        ...
                        <div class="slick-slider carousel-parent" id="carousel-parent" data-items="1" data-swipe="true"
                            ...
                            @foreach (json_decode($mirror->images, true) as $image)
                                <div class="item">
                ...
                <div class="col-lg-6">
                    <div class="single-product">
                        <h6>
                            {{ $mirror->available === 1 ? 'Есть в наличии' : ($mirror->available === 0 ? 'Нет в наличии' : 'Данных нет') }}
                        </h6>

                        <h3 class="text-transform-none font-weight-medium">{!! app()->getLocale() === 'ru' ? $mirror->spaceNameRu : $mirror->spaceNameEn !!}</h3>
                        <div class="group-md group-middle">
                            <div class="single-product-price">{{ $mirror->priceRu }}</div>

                        </div>
                        <p>{!! app()->getLocale() === 'ru' ? $mirror->descriptionRu : $mirror->descriptionEn !!}</p>
                        <hr class="hr-gray-100">
                        <p>{!! app()->getLocale() === 'ru' ? $mirror->articleRu : $mirror->articleEn !!}</p>
                        <ul class="list list-description">
                            <li>
                                <span>guyn</span>
                                <span style="display: flex; gap: 10px; flex-wrap: wrap;margin-top:20px;margin-bottom:25px;">
                                    @foreach (json_decode($mirror->color, true) as $color)
                                        <span
                            ...
                            <li>
                                <div class="content-formPlus">
                                    <span>Форма</span>
                                    <span>
                                        @if (($mirror->shape1 ?? false) && ($mirror->shape2 ?? false))
                                            <h6>Право, Лево</h6>
                                        @elseif($mirror->shape1 ?? false)
                                            <h6>Право</h6>
                                        @elseif($mirror->shape2 ?? false)
                                            <h6>Лево</h6>
                                        @endif
                                    </span>
                                </div>
                            ...
                            <li>
                                <div class="content-info">
                                    ...
                                    <span>
                                        {{ app()->getLocale() === 'ru' ? $mirror->annotationRu : $mirror->annotationEn }}
                                    </span>
                                </div>
                        ...
                        <div class="box-comment">
                            <div class="unit flex-column flex-sm-row unit-spacing-md">
                                ...
                                <div class="unit-body">
                                    ...
                                    <p class="box-comment-text">{!! app()->getLocale() === 'ru' ? $mirror->informationRu : $mirror->informationEn !!}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="tabs-1-2">
                        <div class="single-product-info">
                            <div class="unit unit-spacing-md flex-column flex-sm-row align-items-sm-center">
                                ...
                                <div class="unit-body">
                                    <p>{!! app()->getLocale() === 'ru' ? $mirror->payRu : $mirror->payEn !!}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="tabs-1-3">
                        <div class="single-product-info">
                            <div class="unit unit-spacing-md flex-column flex-sm-row align-items-sm-center">
                                ...
                                <div class="unit-body">
                                    <p>{!! app()->getLocale() === 'ru' ? $mirror->DeliveryRu : $mirror->DeliveryEn !!}</p>
                                </div>
                            </div>
                        </div>
                    </div>

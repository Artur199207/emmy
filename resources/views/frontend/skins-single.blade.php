            ...
            <div class="row row-30">
                <div class="col-lg-6">
                    <div class="slick-vertical slick-product">
                        ...
                        <div class="slick-slider carousel-parent" id="carousel-parent" data-items="1" data-swipe="true"
                            ...
                            @foreach (json_decode($skins->images, true) as $image)
                                <div class="item">
                ...
                <div class="col-lg-6">
                    <div class="single-product">
                        <h6>
                            {{ $skins->available === 1 ? 'Есть в наличии' : ($skins->available === 0 ? 'Нет в наличии' : 'Данных нет') }}
                        </h6>

                        <h3 class="text-transform-none font-weight-medium">{!! app()->getLocale() === 'ru' ? $skins->spaceNameRu : $skins->spaceNameEn !!}</h3>
                        <div class="group-md group-middle">
                            <div class="single-product-price">{{ $skins->priceRu }}</div>

                        </div>
                        <p>{!! app()->getLocale() === 'ru' ? $skins->descriptionRu : $skins->descriptionEn !!}</p>
                        <hr class="hr-gray-100">
                        <p>{!! app()->getLocale() === 'ru' ? $skins->articleRu : $skins->articleEn !!}</p>
                        <ul class="list list-description">
                            ...
                            <li>
                                <div class="content-info">
                                    ...
                                    <span>
                                        {{ app()->getLocale() === 'ru' ? $skins->annotationRu : $skins->annotationEn }}
                                    </span>
                                </div>
                        ...
                        <div class="box-comment">
                            <div class="unit flex-column flex-sm-row unit-spacing-md">
                                ...
                                <div class="unit-body">
                                    ...
                                    <p class="box-comment-text">{!! app()->getLocale() === 'ru' ? $skins->informationRu : $skins->informationEn !!}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="tabs-1-2">
                        <div class="single-product-info">
                            <div class="unit unit-spacing-md flex-column flex-sm-row align-items-sm-center">
                                ...
                                <div class="unit-body">
                                    <p>{!! app()->getLocale() === 'ru' ? $skins->payRu : $skins->payEn !!}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="tabs-1-3">
                        <div class="single-product-info">
                            <div class="unit unit-spacing-md flex-column flex-sm-row align-items-sm-center">
                                ...
                                <div class="unit-body">
                                    <p>{!! app()->getLocale() === 'ru' ? $skins->DeliveryRu : $skins->DeliveryEn !!}</p>
                                </div>
                            </div>
                        </div>
                    </div>

...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{ route('team.create') }}" class="btn btn-primary mb-3 hovcolor">Добавить новый элемент</a>
                ...
                <tbody>
                    @foreach ($team as $locker)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('team.edit', $locker->id) }}"
                                    class="btn btn-warning btn-sm">Редактировать</a>

                                <form action="{{ route('team.destroy', $locker->id) }}" method="POST"

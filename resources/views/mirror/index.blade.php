...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{ route('mirror.create') }}" class="btn btn-primary mb-3 hovcolor">Добавить новый элемент</a>
                ...
                <tbody>
                    @foreach ($mirror as $locker)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('mirror.edit', $locker->id) }}"
                                    class="btn btn-warning btn-sm">Редактировать</a>

                                <form action="{{ route('mirror.destroy', $locker->id) }}" method="POST"

...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ route('pencil.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">

...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{ route('skins.create') }}" class="btn btn-primary mb-3 hovcolor">Добавить новый элемент</a>
                ...
                <tbody>
                    @foreach ($skins as $locker)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('skins.edit', $locker->id) }}"
                                    class="btn btn-warning btn-sm">Редактировать</a>

                                <form action="{{ route('skins.destroy', $locker->id) }}" method="POST"
